...
<div align="center">
<svg fill="none" viewBox="0 0 800 380" width="800" height="380" xmlns="http://www.w3.org/2000/svg">
  <foreignObject width="100%" height="100%">
    <div xmlns="http://www.w3.org/1999/xhtml">
      <style>
        ...
        .line:nth-child(6)  { animation-delay: 1.4s; }
        .line:nth-child(7)  { animation-delay: 1.6s; }
        .line:nth-child(8)  { animation-delay: 1.8s; }
        .line:nth-child(9)  { animation-delay: 2.0s; }
        .line:nth-child(10) { animation-delay: 2.2s; }
        .line:nth-child(11) { animation-delay: 2.6s; }
        .line:nth-child(12) { animation-delay: 3.0s; }
        .line:nth-child(13) { animation-delay: 3.2s; }
        .line:nth-child(14) { animation-delay: 3.6s; }
      ...
      <div class="terminal">
        <div class="terminal-header">
          ...
          <span class="terminal-title">sabbir@dev ~ about-me</span>
        </div>
        <div class="terminal-body">
          <div class="line"><span class="prompt">sabbir@dev:~$</span> <span class="command">cat</span> <span class="flag">about_me.json</span></div>
          <div class="line"><span class="separator">{</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"name"</span><span class="separator">:</span> <span class="string">"Md Sabbir Ahmed"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"title"</span><span class="separator">:</span> <span class="string">"Full-Stack Developer | DevOps Engineer | AI Automation Lead"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"experience"</span><span class="separator">:</span> <span class="string">"10+ Years Professional Experience"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"clients"</span><span class="separator">:</span> <span class="string">"USA &amp; Canadian Companies"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"current_role"</span><span class="separator">:</span> <span class="string">"AI &amp; Automation Team Lead @ Smart-Lab Global"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"focus"</span><span class="separator">:</span> <span class="separator">[</span></div>
          <div class="line">&nbsp;&nbsp;&nbsp;&nbsp;<span class="value">"Cloud Architecture &amp; Automation"</span><span class="separator">,</span> <span class="value">"Scalable Backend Systems"</span><span class="separator">,</span></div>
          <div class="line">&nbsp;&nbsp;&nbsp;&nbsp;<span class="value">"AI Workflow Automation"</span><span class="separator">,</span> <span class="value">"Enterprise CMS Platforms"</span></div>
          <div class="line">&nbsp;&nbsp;<span class="separator">],</span></div>
          <div class="line">&nbsp;&nbsp;<span class="key">"mission"</span><span class="separator">:</span> <span class="string">"Building secure, high-availability systems optimized for speed &amp; scale"</span></div>
          <div class="line"><span class="separator">}</span></div>
          <div class="line"><span class="prompt">sabbir@dev:~$</span> <span class="blink">▋</span></div>
        </div>
      </div>
    </div>
  </foreignObject>
